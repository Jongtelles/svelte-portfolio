<div class="about">
  ...
  <p class="about--tech-skills">
    <strong>Stack 🥞:</strong> React (Hooks) | Vue | TypeScript | Node | JavaScript (ES2015+) |
...
<style>
  .about {
    position: relative;
    background: linear-gradient(#200d3a, #292651, #2e4770, #ce5e82, #eca089, #ecc6a2);
    box-shadow: -10px 10px 10px #2e4770;
    padding: 1rem;
    margin: 2rem auto;
    border-radius: 1rem;
  ...
  .about:hover {
    box-shadow: 25px 25px 10px #2f9395;
  }
